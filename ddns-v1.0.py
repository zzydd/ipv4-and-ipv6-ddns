...
def ControlC_Exit(sig, frame):
    WriteLog('[主程序]-收到Control+C，准备退出')
    WriteLog('[主程序]-退出')
    sys.exit(0)

#【系统关机信号】
def Shutdown_Exit(sig, frame):
    WriteLog('[主程序]-检测到系统关闭，准备退出')
    WriteLog('[主程序]-退出')
    sys.exit(0)
...
while True:
        ...
        if EnableAuto=='True':
            ...
            if IPv4_Change==True or IPv6_Change==True: #IP发生变化，运行更新程序
                ...
                for UpdateListData in UpdateList:
                    ...
                    #更新IPv4
                    if EnableIPv4=='True' and (Mode=='4' or Mode=='46'or Mode=='64'):
                    ...
                    #更新IPv6
                    if EnableIPv6=='True' and (Mode=='6' or Mode=='46'or Mode=='64'):
    ...
    #【容错】
        ...
        WriteLog('[主程序]-[错误]-运行出错：'+str(ErrorMsg))
        time.sleep(3)
        pass
